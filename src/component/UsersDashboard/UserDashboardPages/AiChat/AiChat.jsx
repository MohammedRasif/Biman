...
//                 <div className="flex items-center space-x-4 p-3 b ">
...
//                                 </div>
//                                 <div
//                                     className="px-5 py-4 rounded-lg bg-gray-200 dark:bg-[#1E232E] text-black dark:text-gray-200 lg:text-[16px] shadow-sm w-full"
//                                 >
//                                     <ReactMarkdown>
    ...
    <div className="p-8 h-full flex flex-col">
      <div className="lora flex items-center justify-between p-4">
        <div className="flex flex-col items-start">
          ...
          <div className="border w-full mt-4 border-[#E7E7E7]"></div>
          ...
          {!hasUserSentMessage && (
            <div className="absolute bottom-0">
              <div className="flex items-start space-x-3">
                ...
                <div className="px-5 py-4 rounded-lg bg-gray-200 dark:bg-[#1E232E] text-black dark:text-gray-200 lg:text-[16px] shadow-sm w-full">
            ...
            <div key={index} className="flex w-full">
              {message.isUser ? (
                <div className="flex flex-col items-end w-full">
                  <div className="flex justify-end items-end space-x-3">
                    {message.text ? (
                      <div className="px-4 py-3 rounded-xl bg-[#2F80A9] text-white lg:text-[16px] shadow-md w-1/2">
                        <span>{message.text}</span>
                      </div>
                    ) : (
                      <div className="flex justify-end">
                ...
                <div className="flex flex-col items-start w-full">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="px-5 py-4 rounded-lg bg-gray-200 dark:bg-[#1E232E] text-black dark:text-gray-200 lg:text-[16px] shadow-sm max-w-[70%]">
                      <ReactMarkdown>{message.text}</ReactMarkdown>
                    </div>
                  </div>
                </div>
